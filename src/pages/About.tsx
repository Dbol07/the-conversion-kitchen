...
export default function About() {
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url(https://raw.githubusercontent.com/Dbol07/kitchen-conversion-app/main/assets/backgrounds/bg-about.png)",
          ...
          <DecorativeFrame className="mt-8">
            <div className="p-6">
              <p className="text-[#1b302c] text-lg leading-relaxed mb-6">
                Welcome to{" "}
                <strong className="text-[#3c6150]">The Conversion Kitchen</strong> — 
                your cozy corner of the internet where warm cottage vibes meet 
                practical kitchen magic.
              </p>

              <p className="text-[#1b302c] text-lg leading-relaxed mb-6">
                We created this app for home bakers, recipe lovers, and anyone 
                who's ever wondered, “How many tablespoons are in a cup again?”
              </p>

              <p className="text-[#1b302c] text-lg leading-relaxed mb-6">
                Our mission is to make cooking comforting and stress-free through 
                beautiful tools, printable helpers, and quick-reference guides.
              </p>
